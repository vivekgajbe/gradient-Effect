...
class ThirdViewController: UIViewController {
    @IBOutlet weak var viwGradient: GradientView!
    
    override func viewDidLoad() {
        super.viewDidLoad()
        
        viwGradient.gradientLayer.colors = [UIColor.black.cgColor, UIColor.white.cgColor]
        
        viwGradient.gradientLayer.gradient = GradientPoint.bottomRightTopLeft.draw()
